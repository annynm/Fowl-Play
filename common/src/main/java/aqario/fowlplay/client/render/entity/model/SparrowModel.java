...
public class SparrowModel extends FlyingBirdModel<BirdRenderState> {
  ...
  public static LayerDefinition createBodyLayer() {
    ...
    PartDefinition neck =
        body.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(0, 12)
                .addBox(-1.0F, -1.5F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.001F)),
    ...
    head.addOrReplaceChild(
        ...
        CubeListBuilder.create()
            .texOffs(0, 0)
            .addBox(-0.5F, -3.0F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
    ...
    body.addOrReplaceChild(
        ...
        CubeListBuilder.create()
            .texOffs(0, 0)
            .addBox(-1.5F, -2.0F, -3.0F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)),
    ...
    body.addOrReplaceChild(
        ...
        CubeListBuilder.create()
            .texOffs(14, 0)
            .addBox(-1.5F, -1.0F, -0.5F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)),
        PartPose.offsetAndRotation(1.5F, -2.25F, -1.25F, -0.3927F, 0.0F, 0.0F));
    ...
    body.addOrReplaceChild(
        ...
        CubeListBuilder.create()
            .texOffs(14, 0)
            .mirror()
            .addBox(-0.5F, -1.0F, -0.5F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
            .mirror(false),
        PartPose.offsetAndRotation(-1.5F, -2.25F, -1.25F, -0.3927F, 0.0F, 0.0F));
    ...
    PartDefinition left_wing_open =
        body.addOrReplaceChild(
            ...
            PartPose.offsetAndRotation(1.0F, -2.5F, -0.5F, -0.6109F, 0.0F, 0.0F));
    ...
    body.addOrReplaceChild(
        ...
        CubeListBuilder.create()
            ...
            .texOffs(20, 0)
            .addBox(-1.0F, -1.0F, 3.0F, 2.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)),
  ...
  protected boolean shouldRenderWings(BirdRenderState state) {
    return super.shouldRenderWings(state) && state.flappingState.isStarted();
  }
}