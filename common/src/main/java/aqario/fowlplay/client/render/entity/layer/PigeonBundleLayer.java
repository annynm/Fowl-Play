...
public class PigeonBundleLayer extends RenderLayer<PigeonEntity, PigeonModel> {
  ...
  public PigeonBundleLayer(
      RenderLayerParent<PigeonEntity, PigeonModel> context, ItemInHandRenderer heldItemRenderer) {
    super(context);
  ...
  public void render(
    ...
    this.itemRenderer.renderItem(
        pigeon, stack, ItemDisplayContext.GROUND, false, matrices, vertexConsumers, light);
    matrices.popPose();
  }
}