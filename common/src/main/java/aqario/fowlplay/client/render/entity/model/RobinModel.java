...
public class RobinModel extends FlyingBirdModel<BirdRenderState> {
  ...
  public static LayerDefinition createBodyLayer() {
    ...
    body.addOrReplaceChild(
        ...
        CubeListBuilder.create()
            .texOffs(16, 0)
            .addBox(-0.5F, -1.0F, -0.5F, 1.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)),
        PartPose.offsetAndRotation(1.5F, -2.5F, -1.5F, -0.3927F, 0.0F, 0.0F));
