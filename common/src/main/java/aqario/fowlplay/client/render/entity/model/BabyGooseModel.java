  ...
  public static LayerDefinition createBodyLayer() {
    ...
    PartDefinition neck =
        body.addOrReplaceChild(
            "neck", CubeListBuilder.create(), PartPose.offset(0.0F, -0.25F, -1.25F));
    ...
    head.addOrReplaceChild(
        ...
        CubeListBuilder.create()
            .texOffs(16, 5)
            .addBox(-0.5F, -0.5F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
    ...
    body.addOrReplaceChild(
        ...
        CubeListBuilder.create()
            .texOffs(0, 0)
            .addBox(-1.5F, -3.0F, -3.5F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)),
        PartPose.offsetAndRotation(0.0F, 1.5F, 1.5F, -0.1745F, 0.0F, 0.0F));

    body.addOrReplaceChild(
        "left_wing",
        CubeListBuilder.create()
            .texOffs(8, 8)
            .addBox(-0.5F, -1.0F, -0.5F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)),
        PartPose.offsetAndRotation(1.5F, -1.25F, -0.5F, -0.1745F, 0.0F, 0.0F));
    ...
    left_wing_open.addOrReplaceChild(
        "left_wing_outer", CubeListBuilder.create(), PartPose.offset(4.5F, 0.0F, -1.0F));
    ...
    right_wing_open.addOrReplaceChild(
        "right_wing_outer", CubeListBuilder.create(), PartPose.offset(-4.5F, 0.0F, -1.0F));

    body.addOrReplaceChild(
        "tail",
        CubeListBuilder.create(),
        PartPose.offsetAndRotation(0.0F, -0.5F, 3.0F, -0.2618F, 0.0F, 0.0F));
    ...
    PartDefinition left_leg =
        root.addOrReplaceChild(
            ...
            PartPose.offsetAndRotation(1.0F, 3.0F, 1.5F, -0.1745F, 0.0F, 0.0F));
