...
public class PigeonRenderer extends MobRenderer<PigeonEntity, BirdRenderState, PigeonModel> {
  ...
  public PigeonRenderer(EntityRendererProvider.Context context) {
    ...
    this.addLayer(new PigeonBundleLayer(this, net.minecraft.client.Minecraft.getInstance().getEntityRenderDispatcher().getItemInHandRenderer()));
  }
  ...
  @Override
  public void extractRenderState(PigeonEntity entity, BirdRenderState state, float partialTick) {
