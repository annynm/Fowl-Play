...
public class BirdHeldItemLayer<E extends BirdEntity, M extends BirdModel<E>>
  ...
  public BirdHeldItemLayer(
      RenderLayerParent<E, M> context, ItemInHandRenderer heldItemRenderer, Vec3 heldItemOffset) {
    super(context);
  ...
  public void render(
    ...
    this.itemRenderer.renderItem(
        bird, stack, ItemDisplayContext.GROUND, false, matrices, vertexConsumers, light);
    matrices.popPose();
  }
}