...
public class BabyPenguinLayer extends BirdLayer {

  public static final ModelLayerLocation MODEL_LAYER =
      new ModelLayerLocation(FowlPlay.id("baby_penguin"), "main");
  ...
  public LayerDefinition createLayerDefinition() {
    ...
    PartDefinition body =
        root.addOrReplaceChild(
            "body", CubeListBuilder.create(), PartPose.offset(0.0F, 10.0F, 0.0F));
    ...
    body.addOrReplaceChild(
        ...
        CubeListBuilder.create()
            .texOffs(0, 0)
            .addBox(-3.0F, -8.0F, -2.5F, 6.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)),
    ...
    body.addOrReplaceChild(
        ...
        CubeListBuilder.create()
            .texOffs(22, 0)
            .mirror()
            .addBox(0.0F, -1.0F, -1.5F, 1.0F, 8.0F, 3.0F, new CubeDeformation(0.0F))
            .mirror(false),
    ...
    body.addOrReplaceChild(
        ...
        CubeListBuilder.create()
            .texOffs(22, 0)
            .addBox(-1.0F, -1.0F, -1.5F, 1.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)),
        PartPose.offset(-3.0F, -8.0F, 0.0F));
    ...
    PartDefinition tail =
        body.addOrReplaceChild(
            "tail",
            CubeListBuilder.create(),
            PartPose.offsetAndRotation(0.0F, -3.5F, 2.0F, -0.7854F, 0.0F, 0.0F));
    ...
    root.addOrReplaceChild(
        ...
        CubeListBuilder.create()
            .texOffs(30, 0)
            .mirror()
            .addBox(-1.0F, 0.0F, -3.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
            .mirror(false),
