...
public class VultureRenderer extends MobRenderer<VultureEntity, BirdRenderState, VultureModel> {
  ...
  public void extractRenderState(
      VultureEntity entity, BirdRenderState state, float partialTick) {
