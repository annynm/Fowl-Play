...
public class CustomChickenModel extends EntityModel<BirdRenderState> {
  ...
  public static LayerDefinition createBodyLayer() {
    ...
    PartDefinition head =
        body.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                ...
                .texOffs(0, -3)
                .addBox(0.0F, -7.0F, -2.0F, 0.0F, 2.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(0, 1)
                .addBox(0.5F, -4.0F, -2.0F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 1)
                .addBox(-0.5F, -4.0F, -2.0F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
    ...
    body.addOrReplaceChild(
        ...
        CubeListBuilder.create()
            .texOffs(0, 0)
            .addBox(-2.0F, -3.5F, -6.5F, 4.0F, 4.0F, 7.0F, new CubeDeformation(0.0F)),
        PartPose.offsetAndRotation(0.0F, 0.95F, 2.5F, -0.3491F, 0.0F, 0.0F));

    body.addOrReplaceChild(
        "left_wing",
        CubeListBuilder.create()
            .texOffs(0, 11)
            .addBox(-0.75F, -1.0F, -0.5F, 1.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)),
        PartPose.offsetAndRotation(2.25F, -3.55F, -1.5F, -0.3491F, 0.0F, 0.0F));
    ...
    body.addOrReplaceChild(
        ...
        CubeListBuilder.create()
            .texOffs(0, 11)
            .mirror()
            .addBox(-0.25F, -1.0F, -0.5F, 1.0F, 4.0F, 6.0F, new CubeDeformation(0.0F))
            .mirror(false),
        PartPose.offsetAndRotation(-2.25F, -3.55F, -1.5F, -0.3491F, 0.0F, 0.0F));
    ...
    PartDefinition left_wing_open =
        body.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(8, 19)
                .addBox(-0.5F, 0.0F, -1.0F, 5.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(1.0F, -4.25F, -1.0F, -0.3491F, 0.0F, 0.0F));

    left_wing_open.addOrReplaceChild(
        "left_wing_outer",
        CubeListBuilder.create()
            .texOffs(2, 26)
            .addBox(0.0F, 0.0F, 0.0F, 5.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)),
    ...
    PartDefinition right_wing_open =
        body.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(8, 19)
                .mirror()
                .addBox(-4.5F, 0.0F, -1.0F, 5.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
                .mirror(false),
            PartPose.offsetAndRotation(-1.0F, -4.25F, -1.0F, -0.3491F, 0.0F, 0.0F));
    ...
    right_wing_open.addOrReplaceChild(
        ...
        CubeListBuilder.create()
            .texOffs(2, 26)
            .mirror()
            .addBox(-5.0F, 0.0F, 0.0F, 5.0F, 0.0F, 6.0F, new CubeDeformation(0.0F))
            .mirror(false),
        PartPose.offset(-4.5F, 0.0F, -1.0F));
    ...
    body.addOrReplaceChild(
        ...
        CubeListBuilder.create()
            ...
            .texOffs(22, -1)
            .addBox(0.0F, -6.0F, 1.0F, 0.0F, 8.0F, 5.0F, new CubeDeformation(0.0F)),
        PartPose.offsetAndRotation(0.0F, -2.0F, 2.0F, -0.2618F, 0.0F, 0.0F));
    ...
    PartDefinition left_leg =
        root.addOrReplaceChild(
            ...
            PartPose.offsetAndRotation(1.25F, 1.0F, 1.5F, -0.1745F, 0.0F, 0.0F));
