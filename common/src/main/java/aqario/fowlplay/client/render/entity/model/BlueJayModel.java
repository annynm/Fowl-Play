...
public class BlueJayModel extends FlyingBirdModel<BirdRenderState> {
  ...
  public BlueJayModel(ModelPart root) {
    ...
    this.walkingAnim = BlueJayAnimations.WALKING.bake(root);
    this.standingAnim = BlueJayAnimations.STANDING.bake(root);
    this.swimmingAnim = BlueJayAnimations.SWIMMING.bake(root);
    this.glidingAnim = BlueJayAnimations.GLIDING.bake(root);
    this.flappingAnim = BlueJayAnimations.FLAPPING.bake(root);
  }
  ...
  public static LayerDefinition createBodyLayer() {
    ...
    head.addOrReplaceChild(
        ...
        PartPose.offsetAndRotation(0.0F, -3.0F, 0.2F, 0.4363F, 0.0F, 0.0F));

    head.addOrReplaceChild(
        "beak",
        CubeListBuilder.create()
            .texOffs(16, 3)
            .addBox(-0.5F, -3.0F, -1.5F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
    ...
    body.addOrReplaceChild(
        ...
        CubeListBuilder.create()
            .texOffs(0, 0)
            .addBox(-1.5F, -2.0F, -4.0F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)),
    ...
    body.addOrReplaceChild(
        ...
        CubeListBuilder.create()
            .texOffs(16, 0)
            .addBox(-0.75F, -1.0F, -0.5F, 1.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)),
        PartPose.offsetAndRotation(1.75F, -2.5F, -1.5F, -0.3927F, 0.0F, 0.0F));
    ...
    body.addOrReplaceChild(
        ...
        CubeListBuilder.create()
            .texOffs(16, 0)
            .mirror()
            .addBox(-0.25F, -1.0F, -0.5F, 1.0F, 3.0F, 6.0F, new CubeDeformation(0.0F))
            .mirror(false),
        PartPose.offsetAndRotation(-1.75F, -2.5F, -1.5F, -0.3927F, 0.0F, 0.0F));
    ...
    PartDefinition left_wing_open =
        body.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(8, 9)
                .addBox(-0.5F, 0.0F, -1.0F, 5.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),
    ...
    left_wing_open.addOrReplaceChild(
        ...
        CubeListBuilder.create()
            .texOffs(3, 15)
            .addBox(0.0F, 0.0F, 0.0F, 5.0F, 0.0F, 5.0F, new CubeDeformation(0.0F)),
    ...
    PartDefinition right_wing_open =
        body.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(8, 9)
                .mirror()
                .addBox(-4.5F, 0.0F, -1.0F, 5.0F, 1.0F, 5.0F, new CubeDeformation(0.0F))
                .mirror(false),
            PartPose.offsetAndRotation(-1.0F, -3.25F, -1.0F, -0.6109F, 0.0F, 0.0F));
    ...
    right_wing_open.addOrReplaceChild(
        ...
        CubeListBuilder.create()
            .texOffs(3, 15)
            .mirror()
            .addBox(-5.0F, 0.0F, 0.0F, 5.0F, 0.0F, 5.0F, new CubeDeformation(0.0F))
            .mirror(false),
        PartPose.offset(-4.5F, 0.0F, -1.0F));
    ...
    body.addOrReplaceChild(
        ...
        CubeListBuilder.create()
            ...
            .texOffs(20, 0)
            .addBox(-1.0F, -1.0F, 3.0F, 2.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)),
        PartPose.offsetAndRotation(0.0F, -0.25F, 0.0F, -0.2618F, 0.0F, 0.0F));
