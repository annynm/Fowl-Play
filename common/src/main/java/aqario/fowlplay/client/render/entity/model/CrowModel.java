...
public class CrowModel extends FlyingBirdModel<BirdRenderState> {
  public static final ModelLayerLocation MODEL_LAYER =
      new ModelLayerLocation(FowlPlay.id("crow"), "main");
  ...
  public static LayerDefinition createBodyLayer() {
    ...
    PartDefinition neck =
        body.addOrReplaceChild(
            ...
            PartPose.offset(0.0F, -2.0F, -2.75F));
    ...
    body.addOrReplaceChild(
        ...
        PartPose.offsetAndRotation(0.0F, -0.75F, 0.0F, -0.4363F, 0.0F, 0.0F));

    body.addOrReplaceChild(
        "left_wing",
        CubeListBuilder.create()
            .texOffs(10, 7)
            .addBox(-1.5F, -1.0F, -0.5F, 2.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)),
        PartPose.offsetAndRotation(1.5F, -3.25F, -2.0F, -0.3927F, 0.0F, 0.0F));
    ...
    body.addOrReplaceChild(
        ...
        CubeListBuilder.create()
            .texOffs(10, 7)
            .mirror()
            .addBox(-0.5F, -1.0F, -0.5F, 2.0F, 3.0F, 8.0F, new CubeDeformation(0.0F))
            .mirror(false),
        PartPose.offsetAndRotation(-1.5F, -3.25F, -2.0F, -0.3927F, 0.0F, 0.0F));
    ...
    PartDefinition left_wing_open =
        body.addOrReplaceChild(
            ...
            PartPose.offsetAndRotation(1.0F, -3.75F, -1.5F, -0.4363F, 0.0F, 0.0F));
    ...
    PartDefinition tail =
        body.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                ...
                .texOffs(16, 0)
                .addBox(-1.0F, -1.001F, 3.0F, 2.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(0.0F, -0.75F, 0.5F, -0.2618F, 0.0F, 0.0F));
    ...
    tail.addOrReplaceChild(
        ...
        CubeListBuilder.create()
            .texOffs(16, 0)
            .mirror()
            .addBox(-1.0F, 0.0F, 0.0F, 2.0F, 0.0F, 4.0F, new CubeDeformation(0.0F))
            .mirror(false),
        PartPose.offsetAndRotation(0.0F, -1.0F, 2.25F, 0.0F, -0.5236F, 0.0F));
    ...
    PartDefinition left_leg =
        root.addOrReplaceChild(
            ...
            CubeListBuilder.create()
                .texOffs(2, 3)
                .addBox(-0.5F, -1.0F, 0.0F, 1.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)),
            PartPose.offsetAndRotation(1.0F, 1.0F, 1.0F, -0.2618F, 0.0F, 0.0F));
  ...
  protected void setAnimations(BirdRenderState state) {
    if (!state.isFlying && !state.isInWaterOrBubble) {
      this.animateWalk(CrowAnimations.WALKING, state.limbSwing, state.limbSwingAmount, 5F, 5F);
    }
    this.animate(state.standingState, CrowAnimations.STANDING, state.ageInTicks);
    this.animate(state.swimmingState, CrowAnimations.SWIMMING, state.ageInTicks);
    this.animate(state.glidingState, CrowAnimations.GLIDING, state.ageInTicks);
    this.animate(state.flappingState, CrowAnimations.FLAPPING, state.ageInTicks);
  }
