...
public class VultureEntity extends TrustingBirdEntity implements BirdBrain<VultureEntity> {
  ...
  public Ingredient getFood() {
    return Ingredient.of(net.minecraft.core.registries.BuiltInRegistries.ITEM.getOrThrow(FowlPlayItemTags.VULTURE_FOOD));
  }
  ...
  public boolean canHunt(LivingEntity target) {
    return target.getType().is(FowlPlayEntityTypeTags.VULTURE_HUNT_TARGETS)
        || (target.getType().is(FowlPlayEntityTypeTags.VULTURE_BABY_HUNT_TARGETS)
            && target.isBaby());
  }
  ...
  public BrainActivityGroup<? extends VultureEntity> soarActivity() {
    return BirdBrain.soar(new SetRandomFlightTarget<>());
  }
