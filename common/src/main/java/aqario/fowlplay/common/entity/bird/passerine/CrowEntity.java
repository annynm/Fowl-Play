...
public class CrowEntity extends TrustingBirdEntity implements BirdBrain<CrowEntity> {
  ...
  public Ingredient getFood() {
    return Ingredient.of(net.minecraft.core.registries.BuiltInRegistries.ITEM.getOrThrow(FowlPlayItemTags.CROW_FOOD));
  }
  ...
  public boolean shouldAttack(LivingEntity target) {
    ...
    if (!target.getType().is(FowlPlayEntityTypeTags.CROW_ATTACK_TARGETS)
  ...
  public void updateAnimationStates() {
    this.standingState.animateWhen(!this.isFlying() && !this.isUnderWater(), this.tickCount);
    this.flappingState.animateWhen(this.isFlying(), this.tickCount);
    this.swimmingState.animateWhen(!this.isFlying() && this.isUnderWater(), this.tickCount);
  }
