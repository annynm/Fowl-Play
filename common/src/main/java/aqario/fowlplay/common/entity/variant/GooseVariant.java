...
public record GooseVariant(String id, boolean domesticatable) {
  public static final StreamCodec<RegistryFriendlyByteBuf, Holder<GooseVariant>> PACKET_CODEC =
      ByteBufCodecs.holderRegistry(FPRegistries.GOOSE_VARIANT);
  public static final CommonRegister<GooseVariant> REGISTRAR =
      CommonRegister.create(FPRegistries.GOOSE_VARIANT, FowlPlay.ID);
  ...
  public ModelType modelType(boolean isDomestic) {
    return this.domesticatable && isDomestic ? ModelType.DOMESTIC : ModelType.WILD;
  }
