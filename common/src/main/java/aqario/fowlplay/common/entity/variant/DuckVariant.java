...
public record DuckVariant(String id) {
  public static final StreamCodec<RegistryFriendlyByteBuf, Holder<DuckVariant>> PACKET_CODEC =
      ByteBufCodecs.holderRegistry(FPRegistries.DUCK_VARIANT);
  public static final CommonRegister<DuckVariant> REGISTRAR =
      CommonRegister.create(FPRegistries.DUCK_VARIANT, FowlPlay.ID);
  ...
  public ModelType modelType(boolean isDomestic) {
    return isDomestic ? ModelType.DOMESTIC : ModelType.WILD;
  }
