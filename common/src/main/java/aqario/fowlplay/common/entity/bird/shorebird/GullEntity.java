...
public class GullEntity extends TrustingBirdEntity
    implements BirdBrain<GullEntity>, VariantHolder<GullVariant> {
  private static final EntityDataAccessor<Holder<GullVariant>> VARIANT =
      SynchedEntityData.defineId(GullEntity.class, FPEntityDataSerializers.GULL_VARIANT);
  ...
  public Ingredient getFood() {
    return Ingredient.of(net.minecraft.core.registries.BuiltInRegistries.ITEM.getOrThrow(FowlPlayItemTags.GULL_FOOD));
  }
  ...
  public BrainActivityGroup<? extends GullEntity> forageActivity() {
    return BirdBrain.forage(
        new SetHuntTarget<>().targetPredicate(BiPredicates.not(BirdUtils::isSelfAndTargetInWater)),
        new OneRandomBehaviour<>(
            Pair.of(CompositeBehaviours.trySetNonAirWalkTarget(), 1),
