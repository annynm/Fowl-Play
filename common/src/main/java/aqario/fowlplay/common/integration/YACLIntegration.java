...
public class YACLIntegration {
  public static final ConfigClassHandler<FowlPlayConfig> HANDLED_CONFIG =
                        ...
                        ConfigCategory.createBuilder()
                            ...
                            .option(
                                Option.createBuilder(Boolean.class)
                                    .name(
                                        Component.translatable("config.visual.customChickenModel"))
                                    .description(
                                            ...
                                            Component.translatable("config.info.restart")
                                                ...
                                                .append(
                                                    Component.translatable(
                                                        "config.visual.customChickenModel.desc"))))
                                    .binding(
                                        true,
  ...
  private static Option<Integer> createSpawningOption(
      String entity,
      String name,
      String description,
      int defaultValue,
